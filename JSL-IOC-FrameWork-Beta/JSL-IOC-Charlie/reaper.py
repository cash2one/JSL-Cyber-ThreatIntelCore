...
def reap(file_name):
    ...
    ## Setting the User-Agent - This may be the cause of abug due to the URL extension to the charlie framework
    headers = {'User-Agent': 'JSL-Cyber-ThreatIntelCore/0.1.2 (+https://github.com/JohnSnowLabs/JSL-Cyber-ThreatIntelCore)'}
