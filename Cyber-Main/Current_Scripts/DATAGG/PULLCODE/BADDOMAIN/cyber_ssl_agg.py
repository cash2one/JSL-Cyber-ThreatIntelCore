...
badIpSources = {
  'https://sslbl.abuse.ch/downloads/ssl_extended.csv':'BADIPSSSL',
  'https://sslbl.abuse.ch/blacklist/sslipblacklist_aggressive.csv':'BADIPSSSL',
  'https://sslbl.abuse.ch/blacklist/sslipblacklist_aggressive.rules':'BADIPSSSL',
  'https://sslbl.abuse.ch/blacklist/dyre_sslipblacklist_aggressive.csv':'BADIPSSSL',
  'https://sslbl.abuse.ch/blacklist/dyre_sslipblacklist_aggressive.rules':'BADIPSSSL',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/sslbl.ipset':'BADIPSSSL',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/sslproxies.ipset':'BADIPSSSL',
 }
