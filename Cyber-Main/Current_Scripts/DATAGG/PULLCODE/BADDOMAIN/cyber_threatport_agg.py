...
badIpSources = {
  'http://atlas.arbor.net/summary/attacks.csv':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/bi_bruteforce_2_30d.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/bi_bruteforce_2_30d.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/bi_ssh_2_30d.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/blocklist_de_bruteforce.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/blocklist_de_ssh.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/bruteforceblocker.ipset':'BADIPSAttackPorts',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/cruzit_web_attacks.ipset':'BADIPSAttackPorts',
  'http://www.openbl.org/lists/base_all_ftp-only.txt':'BADIPSAttackPorts',
  'http://www.openbl.org/lists/base_all_http-only.txt':'BADIPSAttackPorts',
  'http://www.openbl.org/lists/base_all_mail-only.txt':'BADIPSAttackPorts',
  'http://www.openbl.org/lists/base_all_smtp-only.txt':'BADIPSAttackPorts',
  'http://www.openbl.org/lists/base_all_ssh-only.txt':'BADIPSAttackPorts',
  'http://blocklist.greensnow.co/greensnow.txt':'BADIPSAttackPorts',
  'http://reputation.alienvault.com/reputation.data':'BADIPSAttackPorts',
  'http://www.blocklist.de/lists/bruteforcelogin.txt':'BADIPSAttackPorts',
  'http://dragonresearchgroup.org/insight/sshpwauth.txt':'BADIPSAttackPorts',
  'https://isc.sans.edu//top10.html':'BADIPSAttackPorts',
  'http://danger.rulez.sk/projects/bruteforceblocker/blist.php':'BADIPSAttackPorts',
  'http://www.mtc.sri.com/live_data/attackers/':'BADIPSAttackPorts',
  'https://www.autoshun.org/files/shunlist.csv':'BADIPSAttackPorts',
}
