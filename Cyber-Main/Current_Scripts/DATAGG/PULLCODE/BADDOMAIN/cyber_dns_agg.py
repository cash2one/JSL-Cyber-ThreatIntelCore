...
badIpSources = {
  'http://wget-mirrors.uceprotect.net/rbldnsd-all/dnsbl-1.uceprotect.net.gz':'DNSBLBADIPS',
  'http://wget-mirrors.uceprotect.net/rbldnsd-all/dnsbl-2.uceprotect.net.gz':'DNSBLBADIPS',
  'http://wget-mirrors.uceprotect.net/rbldnsd-all/dnsbl-3.uceprotect.net.gz':'DNSBLBADIPS',
  'http://www.openbl.org/lists/base_all.txt':'DNSBLBADIPS',
  'https://rules.emergingthreats.net/open/suricata/rules/emerging-dns.rules':'DNSBLBADIPS',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/openbl_1d.ipset':'DNSBLBADIPS',
}

badDomainSources = {
  'https://malc0de.com/bl/ZONES':'DNSBLBADDOMAINS',
  'https://www.dshield.org/feeds/suspiciousdomains_Low.txt':'DNSBLBADDOMAINS',
  'https://www.dshield.org/feeds/suspiciousdomains_Medium.txt':'DNSBLBADDOMAINS',
  'https://www.dshield.org/feeds/suspiciousdomains_High.txt':'DNSBLBADDOMAINS',
  'http://ransomwaretracker.abuse.ch/downloads/RW_DOMBL.txt':'DNSBLBADDOMAINS',
  'http://ransomwaretracker.abuse.ch/downloads/RW_URLBL.txt':'DNSBLBADDOMAINS',
  'http://www.nothink.org/blacklist/blacklist_malware_dns.txt':'DNSBLBADDOMAINS',
}
