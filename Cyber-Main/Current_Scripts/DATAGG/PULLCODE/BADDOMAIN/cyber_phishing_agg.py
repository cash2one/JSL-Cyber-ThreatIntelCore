...
badIpSources = {
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/cleanmx_phishing.ipset':'BADDOMAINSPHISHING',
  'https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/atlas_phishing.ipset':'BADDOMAINSPHISHING',
}

badDomainSources = {
  'https://openphish.com/feed.txt':'BADIPSPHISHING',
  'http://data.phishtank.com/data/online-valid.csv':'BADIPSPHISHING',
}
