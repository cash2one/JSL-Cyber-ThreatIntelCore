...
##        item['whoIs'] = url
        ...
        item['Fingerprint_Code'] = ''
        #item['whoIs'] = urls[i]  #not giving away this data   
        item['Exit_Address'] = ''
        item['Exit_Address_Date'] = ''
        item['Exit_Address_Time'] = ''
        item['Individual_Name'] = ''
        item['Dir_Port_Text'] = ''
        item['Descriptor_Publish_date'] = ''
        item['Descriptor_Publish_time'] = ''
        item['Platform_Text'] = ''
        item['Platform_Version_Text'] = ''
        item['Bandwidth_Units'] = ''
        item['Family_Members_list_of_codes'] = ''
        item['is_Authority'] = ''
        item['is_Bad_Directory'] = ''
        item['is_Bad_Exit'] = ''
        item['is_Exit'] = ''
        item['is_Fast'] = ''
        item['is_Guard'] = ''
        ...
        item['is_Exit_Reject'] = ''
        item['Onion_Key_Code'] = ''
        item['Signing_Key_Code'] = ''
        item['Site_Operator_Name'] = ''
...
#1 scrapy crawl toripres2 -o TOR_IP_RESOLUTION_08_ii.csv
